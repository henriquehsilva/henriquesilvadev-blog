    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Busque por um conteúdo específico aqui..."
        />
      </div>
      ...
      <ul className="list-none">
        {posts &&
          posts.map((post) => (
            <li className="py-2">
              <a className="text-lg text-blue-700 hover:text-blue-900 hover:underline underline-offset-2" href={`blog/${post.frontmatter.slug}`}>{post.frontmatter.title}</a>
